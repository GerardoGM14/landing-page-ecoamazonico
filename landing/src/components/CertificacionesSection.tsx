            ...
            {isoImages.length > 0 && (
              <div className="mt-10 md:mt-12 flex justify-end">
                <button
                  ...
                  className="bg-eco-lime text-green-950 px-6 py-3 rounded-md text-base md:text-lg font-bold uppercase tracking-wide hover:bg-white hover:text-green-900 transition duration-300 inline-flex items-center gap-2 cursor-pointer"
                >
